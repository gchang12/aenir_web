...
urlpatterns = [
    ...
    path("<int:id>/promote/", views.LevelUpView.as_view(), name="promote"),
    path("<int:id>/use_stat_booster/", views.LevelUpView.as_view(), name="use_stat_booster"),
    path("<int:id>/use_afas_drops/", views.LevelUpView.as_view(), name="use_afas_drops"),
    path("<int:id>/use_metiss_tome/", views.LevelUpView.as_view(), name="use_metiss_tome"),
    ...
    path("components/<int:id>/action_forecast/", views.LevelUpView.as_view(), name="action_forecast"),
]
